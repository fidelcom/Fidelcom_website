                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('contact.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="url" name="facebook" placeholder="Facebook Link" id="example-text-input">
                                </div>
                            </div>
                            <!-- end row -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="url" name="youtube" placeholder="Youtube Link" id="example-text-input">
                                </div>
                            </div>
                            <!-- end row -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="url" name="google" placeholder="google Link" id="example-text-input">
                                </div>
                            </div>
                            <!-- end row -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="url" name="pinterest" placeholder="Pinterest Link" id="example-text-input">
                                </div>
                            </div>
                            <!-- end row -->
